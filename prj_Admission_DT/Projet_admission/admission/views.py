...
def index_view(request):
    if request.method=='POST':
        ...
        # if 'past_response' not in request.session:
        #      request.session["past_response"] = []
        # if 'past_input' not in request.session:
        #     request.session['past_input'] = []
        # output = generate_response(message)
        # request.session["past_input"].append(message)
        # request.session["past_input"].append(output)
        # print(f' voila le message {message}')
