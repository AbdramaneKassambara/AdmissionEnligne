...
def etat_demande(request):
   ...
   # releve_note = documents.releve_note
    ...
    pytesseract.pytesseract.tesseract_cmd = r'C:\Users\KASSAMBARA ABRAMANE\source\repos\prj_Admission_DT\Tesseract-OCR\tesseract.exe'
    ...
    text_releve_note = extract_text_from_image(lettre_motivation)
